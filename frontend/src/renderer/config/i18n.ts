...
const translations = {
  vi: {
    ...
    radmin_closed_warning: "Radmin VPN đã bị đóng! Vui lòng bật lại để tiếp tục chơi.",
  ...
  en: {
    ...
    radmin_closed_warning: "Radmin VPN was closed! Please restart it to continue playing.",
